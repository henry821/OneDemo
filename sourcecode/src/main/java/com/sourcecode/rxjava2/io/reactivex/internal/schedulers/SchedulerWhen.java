 ...
 */
package com.sourcecode.rxjava2.io.reactivex.internal.schedulers;
...
import com.sourcecode.rxjava2.io.reactivex.Flowable;
import com.sourcecode.rxjava2.io.reactivex.Observable;
import com.sourcecode.rxjava2.io.reactivex.Scheduler;
import com.sourcecode.rxjava2.io.reactivex.annotations.NonNull;
...
import com.sourcecode.rxjava2.io.reactivex.processors.FlowableProcessor;
import com.sourcecode.rxjava2.io.reactivex.processors.UnicastProcessor;
 ...
 * <p>
 * When the {@link com.sourcecode.rxjava2.io.reactivex.Scheduler.Worker Worker} is unsubscribed the {@link Completable} emits an
 ...
 * the number of concurrent {@link com.sourcecode.rxjava2.io.reactivex.Scheduler.Worker Worker}s rather than individual actions.
 * Generally each {@link Observable} uses its own {@link com.sourcecode.rxjava2.io.reactivex.Scheduler.Worker Worker}. This means
 * that this will essentially limit the number of concurrent subscribes. The
 * danger comes from using operators like
 * {@link Flowable#zip(org.reactivestreams.Publisher, org.reactivestreams.Publisher, com.sourcecode.rxjava2.io.reactivex.functions.BiFunction)} where
