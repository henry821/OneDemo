...
import com.sourcecode.rxjava2.io.reactivex.annotations.CheckReturnValue;
import com.sourcecode.rxjava2.io.reactivex.annotations.Nullable;
import com.sourcecode.rxjava2.io.reactivex.annotations.NonNull;
import java.lang.reflect.Array;
import java.util.concurrent.atomic.AtomicReference;
import java.util.concurrent.locks.*;

import com.sourcecode.rxjava2.io.reactivex.Observer;
...
import com.sourcecode.rxjava2.io.reactivex.internal.util.AppendOnlyLinkedArrayList.NonThrowingPredicate;
 ...
 * <p>
 * Since a {@code BehaviorSubject} is an {@link com.sourcecode.rxjava2.io.reactivex.Observable}, it does not support backpressure.
 * <p>
 * When this {@code BehaviorSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()}, the
 * last observed item (if any) is cleared and late {@link com.sourcecode.rxjava2.io.reactivex.Observer}s only receive
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code BehaviorSubject} does not operate by default on a particular {@link com.sourcecode.rxjava2.io.reactivex.Scheduler} and
