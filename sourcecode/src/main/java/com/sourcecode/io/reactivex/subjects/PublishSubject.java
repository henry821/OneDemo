 ...
 * <p>
 * Since a {@code PublishSubject} is an {@link com.sourcecode.io.reactivex.Observable}, it does not support backpressure.
 * <p>
 * When this {@code PublishSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link com.sourcecode.io.reactivex.Observer}s only receive the respective terminal event.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code PublishSubject} does not operate by default on a particular {@link com.sourcecode.io.reactivex.Scheduler} and
