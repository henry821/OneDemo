 ...
 */
package com.sourcecode.io.reactivex.internal.schedulers;

import java.util.concurrent.TimeUnit;
import java.util.concurrent.atomic.AtomicBoolean;
import java.util.concurrent.atomic.AtomicReference;

import com.sourcecode.io.reactivex.Completable;
import com.sourcecode.io.reactivex.CompletableObserver;
...
import com.sourcecode.io.reactivex.annotations.NonNull;
import com.sourcecode.io.reactivex.disposables.Disposable;
import com.sourcecode.io.reactivex.disposables.Disposables;
import com.sourcecode.io.reactivex.functions.Function;
import com.sourcecode.io.reactivex.internal.util.ExceptionHelper;
import com.sourcecode.io.reactivex.processors.FlowableProcessor;
import com.sourcecode.io.reactivex.processors.UnicastProcessor;
 ...
 * <p>
 * When the {@link com.sourcecode.io.reactivex.Scheduler.Worker Worker} is unsubscribed the {@link Completable} emits an
 ...
 * the number of concurrent {@link com.sourcecode.io.reactivex.Scheduler.Worker Worker}s rather than individual actions.
 * Generally each {@link Observable} uses its own {@link com.sourcecode.io.reactivex.Scheduler.Worker Worker}. This means
 * that this will essentially limit the number of concurrent subscribes. The
 * danger comes from using operators like
 * {@link Flowable#zip(org.reactivestreams.Publisher, org.reactivestreams.Publisher, com.sourcecode.io.reactivex.functions.BiFunction)} where
