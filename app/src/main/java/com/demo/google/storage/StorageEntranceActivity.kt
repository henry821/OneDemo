...
import com.demo.google.storage.actionopendocument.MainActivity
...
class StorageEntranceActivity : EntranceActivity() {
    ...
    override fun initData(): List<MainData> {
        ...
        list.add(MainData(getString(R.string.action_open_document_app_name), MainActivity::class.java))
        return list
    }
