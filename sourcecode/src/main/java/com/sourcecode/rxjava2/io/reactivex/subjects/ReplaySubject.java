 ...
 * <p>
 * Since a {@code ReplaySubject} is an {@link com.sourcecode.rxjava2.io.reactivex.Observable}, it does not support backpressure.
 * <p>
 * When this {@code ReplaySubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link com.sourcecode.rxjava2.io.reactivex.Observer}s will receive the retained/cached items first (if any) followed by the respective
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code ReplaySubject} does not operate by default on a particular {@link com.sourcecode.rxjava2.io.reactivex.Scheduler} and
