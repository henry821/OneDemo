...
import com.sourcecode.rxjava2.io.reactivex.internal.subscriptions.DeferredScalarSubscription;
 ...
 * <p>
 * {@code AsyncProcessor} is a {@link com.sourcecode.rxjava2.io.reactivex.Flowable} as well as a {@link FlowableProcessor} and supports backpressure from the downstream but
 ...
 *  When the {@code AsyncProcessor} is subscribed to a {@link com.sourcecode.rxjava2.io.reactivex.Flowable}, the processor consumes this
 *  {@code Flowable} in an unbounded manner (requesting `Long.MAX_VALUE`) as only the very last upstream item is
 *  retained by it.
 *  </dd>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code AsyncProcessor} does not operate by default on a particular {@link com.sourcecode.rxjava2.io.reactivex.Scheduler} and
