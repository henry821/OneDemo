...
import com.sourcecode.io.reactivex.internal.util.AppendOnlyLinkedArrayList.NonThrowingPredicate;
 ...
 * <p>
 * Since a {@code BehaviorSubject} is an {@link com.sourcecode.io.reactivex.Observable}, it does not support backpressure.
 * <p>
 * When this {@code BehaviorSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()}, the
 * last observed item (if any) is cleared and late {@link com.sourcecode.io.reactivex.Observer}s only receive
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code BehaviorSubject} does not operate by default on a particular {@link com.sourcecode.io.reactivex.Scheduler} and
