...
package com.sourcecode.io.reactivex.annotations;
...
public @interface SchedulerSupport {
     ...
     */
    String COMPUTATION = "com.sourcecode.io.reactivex:computation";
    /**
     * The operator/class runs on RxJava's {@linkplain Schedulers#io() I/O scheduler} or takes
     * timing information from it.
     */
    String IO = "com.sourcecode.io.reactivex:com.sourcecode.io";
    /**
     ...
     */
    String NEW_THREAD = "com.sourcecode.io.reactivex:new-thread";
    /**
     * The operator/class runs on RxJava's {@linkplain Schedulers#trampoline() trampoline scheduler}
     * or takes timing information from it.
     */
    String TRAMPOLINE = "com.sourcecode.io.reactivex:trampoline";
    /**
     ...
     * @since 2.2
     */
    String SINGLE = "com.sourcecode.io.reactivex:single";
