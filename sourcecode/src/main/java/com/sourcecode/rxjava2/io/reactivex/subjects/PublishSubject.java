 ...
 * <p>
 * Since a {@code PublishSubject} is an {@link com.sourcecode.rxjava2.io.reactivex.Observable}, it does not support backpressure.
 * <p>
 * When this {@code PublishSubject} is terminated via {@link #onError(Throwable)} or {@link #onComplete()},
 * late {@link com.sourcecode.rxjava2.io.reactivex.Observer}s only receive the respective terminal event.
 * <p>
 ...
 * <dl>
 *  <dt><b>Scheduler:</b></dt>
 *  <dd>{@code PublishSubject} does not operate by default on a particular {@link com.sourcecode.rxjava2.io.reactivex.Scheduler} and
